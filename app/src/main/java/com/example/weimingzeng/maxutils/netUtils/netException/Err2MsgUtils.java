...
public class Err2MsgUtils {
    ...
    private static void initMsg() {
        //自定义错误
        mMap.put(CODE_UNKNOW_ERROR, "网络异常，请稍候再试");
        mMap.put(CODE_NET_DISABLE, "当前网络不可用，请检查网络设置");
        mMap.put(CODE_NET_TIMEOUT, "网络异常，请稍候再试");//网络超时
        mMap.put(CODE_NO_RESPONSE, "服务异常，请稍候再试");
        mMap.put(CODE_PARSE_ERROR, "服务器异常，请稍候再试(" + CODE_PARSE_ERROR + ")"); //解析出错
        mMap.put(CODE_TOKEN_TIMEOUT, "token失效，请稍候再试");
